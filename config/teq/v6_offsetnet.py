...
from geoseg.losses.offsetnet import ConfidenceWeightedCrossEntropyLoss
from geoseg.datasets.teq_dataset import *
from geoseg.models.OffsetNetv2 import OffsetNet
from geoseg.models.OffsetDeeplabv3plus import OffsetDeepLabV3Plus
...
weights_name = "offsetdeeplab-v6-object"
weights_path = "model_weights/offsetnet/{}".format(weights_name)
test_weights_name = "last-v1"  # "offset-v5-pretrain-xbd-RSB-predict-object-v1"
log_name = "offsetdeeplab-v6/{}".format(weights_name)
visualize_name = "vis_logs/offsetdeeplab-v6/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
