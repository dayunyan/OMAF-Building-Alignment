...
weights_name = "offset-nogauss-pretrain-xbd-l1loss-freezed"
weights_path = "model_weights/offset/{}".format(weights_name)
test_weights_name = "offset-nogauss-pretrain-xbd-l1loss-freezed"
log_name = "offset-nogauss-pretrain-xbd/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
