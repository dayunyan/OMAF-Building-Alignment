...
weights_name = "segformer-mitb5-512-crop-e105"  # deeplab-w-pred_offsets
weights_path = "model_weights/offset/{}".format(weights_name)
test_weights_name = "segformer-mitb5-512-crop-e105"
log_name = "segformer-mitb5-512-crop-e105/{}".format(weights_name)
visualize_name = "vis_logs/segformer-mitb5-512-crop-e105/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
