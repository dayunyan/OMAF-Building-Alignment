...
from geoseg.models.OffsetNet import OffsetNet_v2
...
weights_name = "offset-v4-pretrain-xbd-RSB-predict-object"
weights_path = "model_weights/offset/{}".format(weights_name)
test_weights_name = "offset-v4-pretrain-xbd-RSB-predict-object"
log_name = "offset-v4-pretrain-xbd/{}".format(weights_name)
visualize_name = "vis_logs/offset-v4-pretrain-xbd/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
...
layerwise_params = {
    ...
    "decoder.*": dict(lr=backbone_lr, weight_decay=backbone_weight_decay),
}
