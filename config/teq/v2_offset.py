...
from geoseg.models.OffsetNet import OffsetNet
...
weights_name = "offset-v3-pretrain-xbd-softemd-freezed"
weights_path = "model_weights/offset/{}".format(weights_name)
test_weights_name = "offset-v3-pretrain-xbd-softemd-freezed"
log_name = "offset-v3-pretrain-xbd/{}".format(weights_name)
visualize_name = "vis_logs/offset-v3-pretrain-xbd/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
...
val_dataset = TeqDataset(
    data_root="../data/segmentation/Turkey/Islahiye/pre/val",
    mode="val",
    transform=val_aug,
)
...
layerwise_params = {
    ...
    "decoder.*": dict(lr=backbone_lr, weight_decay=weight_decay),
}
