...
from geoseg.models.OffsetNet_build import OffsetNet
...
weights_name = "offset_build-r18-512-crop-ms-e105"
weights_path = "model_weights/offset_build/{}".format(weights_name)
test_weights_name = "offset_build-r18-512-crop-ms-e105"
log_name = "offset_build/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
...
beunet_params = {
    "onnx_path": "pretrained_weights/building_estimation/model.onnx",
    "beunet_path": "pretrained_weights/building_estimation/model.pth",
}
