...
weights_name = "offset-v5-pretrain-xbd-RSB-predict-object"
...
log_name = "offset-v5-pretrain-xbd/{}".format(weights_name)
visualize_name = "vis_logs/offset-v5-pretrain-xbd/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
...
# inner optimization hyperparameters (for train_offset_v3)
inner_iters = 20
inner_lr = 0.01
amplification = 1.0
