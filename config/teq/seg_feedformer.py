...
from geoseg.models.feedformer import Feedformer
...
weights_name = "feedformer-mitb2-w-pred_offsets"  # deeplab-w-pred_offsets
weights_path = "model_weights/offset/{}".format(weights_name)
test_weights_name = "feedformer-mitb2-w-pred_offsets"
log_name = "feedformer-mitb2-w-pred_offsets/{}".format(weights_name)
visualize_name = "vis_logs/feedformer-mitb2-w-pred_offsets/{}".format(weights_name)
monitor = "val_F1"
monitor_mode = "max"
save_top_k = 1
save_last = True
...
net = Feedformer(
    backbone={
        "pretrain": "pretrained_weights/segformer.b2.512x512.ade.160k.pth",
        "variety": "b2",
    },
    decoder={
