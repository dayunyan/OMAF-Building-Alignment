...
from geoseg.models.backbones.vmamba import Backbone_VSSM
from geoseg.models.decoders.uper_head import UPerHead
...
class VMamba(nn.Module):
    ...
    def __init__(self, backbone: Dict, decoder: Dict, pretrained=None) -> None:
        ...
        self.backbone = Backbone_VSSM(**backbone)
        self.decode_head = UPerHead(**decoder)
