...
try:
    from geoseg.models.mamba.csm_triton import cross_scan_fn, cross_merge_fn
except:
    from mamba.csm_triton import cross_scan_fn, cross_merge_fn

try:
    from geoseg.models.mamba.csms6s import selective_scan_fn, selective_scan_flop_jit
except:
    from mamba.csms6s import selective_scan_fn, selective_scan_flop_jit

# FLOPs counter not prepared fro mamba2
try:
    from geoseg.models.mamba.mamba2.ssd_minimal import selective_scan_chunk_fn
except:
    from mamba.mamba2.ssd_minimal import selective_scan_chunk_fn
    ...
    def __initv2__(
        ...
        **kwargs,
        ...
        FORWARD_TYPES = dict(
            ...
            v052d3=partial(
                self.forward_corev2, force_fp32=False, no_einsum=True, scan_mode=3
            ),  # debug
            # ===============================
            v2=partial(
                self.forward_corev2,
...
class Backbone_VSSM(VSSM):
    ...
    def load_pretrained(self, ckpt=None, key="model"):
        ...
        try:
            ...
            print(f"Successfully load ckpt {ckpt}\n{_ckpt['state_dict'].keys()}")
            incompatibleKeys = self.load_state_dict(_ckpt["state_dict"], strict=False)
