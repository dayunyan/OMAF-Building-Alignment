        ...
        for i in range(1, blocks):
            layers.append(
                block(
                    ...
                    dilation=(
                        dilation if multi_grid is None else multi_grid[i] * dilation
                    ),
...
def get_convnet(
    ...
    convnet = ResNet(
        variety=variety,
        block=_block,
        layers=layers_table[depth],
        out_indices=out_indices,
        strides=strides_table[output_stride],
        dilations=dilations_table[output_stride],
        contract_dilation=contract_dilation,
        multi_grid=_multi_grid,
